...
public class VwAdmLogValueDeserializer extends JsonDeserializer<VwAdmLogValue> {

	@Override
	public VwAdmLogValue deserialize(JsonParser jp, DeserializationContext ctxt) 
		...
		VwAdmLogValue pc = new VwAdmLogValue(id);
