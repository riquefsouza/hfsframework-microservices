...
public class AdmUserDeserializer extends JsonDeserializer<AdmUser> {

	@Override
	public AdmUser deserialize(JsonParser jp, DeserializationContext ctxt) 
