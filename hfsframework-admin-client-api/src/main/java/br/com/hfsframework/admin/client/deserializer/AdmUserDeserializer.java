...
public class AdmUserDeserializer extends JsonDeserializer<AdmUserDTO> {

	@Override
	public AdmUserDTO deserialize(JsonParser jp, DeserializationContext ctxt) 
		...
		AdmUserDTO pc = new AdmUserDTO(id);
