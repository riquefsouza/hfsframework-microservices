...
public class Metadata implements Serializable {
	...
	/** The objetos. */
	private List<MetadataObject> objetos;
	 ...
	 */
	public Metadata(String versaoDriverJDBC, String versaoBancoDeDados, boolean suportaSelectForUpdate,
			boolean suportaTransacoes, List<MetadataObject> objetos) {
		super();
	 ...
	 * @return the objetos
	 */
	public List<MetadataObject> getObjetos() {
		return objetos;
	}
	 ...
	 */
	public void setObjetos(List<MetadataObject> objetos) {
		this.objetos = objetos;
	}
