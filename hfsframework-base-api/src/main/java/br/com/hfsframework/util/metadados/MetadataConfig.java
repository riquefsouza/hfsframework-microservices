...
public class MetadataConfig implements Serializable {
	 ...
	 */
	public MetadataConfig(String conexaoURL, String driverClasse, String usuario, String senha) {
		super();
	 ...
	 */
	public static MetadataConfig hfsbancoDS() {
		...
		MetadataConfig cfg = new MetadataConfig(conexaoURL, driverClasse, usuario, senha);
		return cfg;
	}
