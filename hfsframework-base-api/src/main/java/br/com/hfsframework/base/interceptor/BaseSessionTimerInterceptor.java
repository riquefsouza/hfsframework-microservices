...
public class BaseSessionTimerInterceptor extends HandlerInterceptorAdapter {

	private static Logger log = LoggerFactory.getLogger(BaseSessionTimerInterceptor.class);
