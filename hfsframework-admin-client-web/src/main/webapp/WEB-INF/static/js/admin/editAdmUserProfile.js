class EditAdmUserProfile extends HFSSystemUtil {
	constructor()
	{
		super();
...
$(function() {
	const editAdmUserProfile = new EditAdmUserProfile();
	
	$('#btnCancel').click(editAdmUserProfile.btnCancelClick.bind(editAdmUserProfile));
