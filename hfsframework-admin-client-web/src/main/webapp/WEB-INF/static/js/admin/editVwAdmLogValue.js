class EditVwAdmLogValue extends HFSSystemUtil {
	constructor()
	{
		super();
...
$(function() {
	const editVwAdmLogValue = new EditVwAdmLogValue();
	
	$('#btnCancel').click(editVwAdmLogValue.btnCancelClick.bind(editVwAdmLogValue));
